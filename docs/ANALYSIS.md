...
### Permission System
26 permissions defined in `App/permissions.py` (web, incl. `membership.view`/`membership.import` added 2026-08-14). Same permission strings checked in SemirPhone via `UserSession.hasPermission()` (mobile):
