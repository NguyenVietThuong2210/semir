...
class CouponChartPage extends ConsumerWidget {
  const CouponChartPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final chartAsync = ref.watch(couponChartProvider);
    final selectedSlice = ref.watch(selectedSliceLabelProvider);

    return Scaffold(
      appBar: AppBar(title: const Text('Coupon Charts')),
      body: Stack(
        children: [
          chartAsync.when(
